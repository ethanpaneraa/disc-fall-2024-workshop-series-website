...
2. Navigate to your local project repository from assignment 4.
   ...
   (or whatever branch contains all your changes from assignment 4). - Run `git branch` to check what branch you are on. - Run `git checkout branch-name` to switch to a different branch.
...
- The workshop 5 slides and recording, which you can find [here](/content/workshops/workshop-5)
- The workshop 4 slides and recording, which you can find [here](/content/workshops/workshop-4).
  The useEffect section may be useful.
- [Demo of the Users Api](https://www.loom.com/share/87b05404e35e42e5b48758ea7956d9b5)
- [File for creating forms for handling more complex request](https://github.com/DISC-NU/workshop-5-frontend/blob/main/src/pages/ProductForm.tsx). _you essentially repeat the same logic for the `users` api, you're just changing some parts of the code_
