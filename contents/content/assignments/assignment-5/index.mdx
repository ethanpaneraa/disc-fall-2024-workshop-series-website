...
---
*First, complete [assignment 4](/content/assignments/assignment-4) if you haven't already. 
That assignment is prerequisite; 
it would be a poor use of time to learn about routing 
and API calls if you aren't already familiar with React.* 
...
- The [demo ecommerce app](https://github.com/DISC-NU/workshop-5-activities) 
